      ...
      {open && (
        <div className="fixed inset-0 z-[999]">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4">
            <div className="w-full max-w-2xl rounded-2xl border border-white/10 bg-black/60 backdrop-blur-xl shadow-2xl overflow-hidden">
              <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
                ...
                <button
                  onClick={close}
                  className="rounded-xl px-3 py-2 border border-white/10 bg-white/5 hover:bg-white/10 font-bold text-white/80"
                >
                  Хаах
                </button>
              </div>
              ...
              <div className="p-5">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-xl px-4 py-3 bg-white/5 border border-white/10 outline-none text-white"
                  />
                  <button
                    onClick={onSearch}
                    disabled={loading}
                  ...
                  <div className="mt-5">
                    ...
                    <div className="mt-4 space-y-3">
                              ...
                              <div className="font-extrabold text-white">
                                ...
                                <span className="text-white/85">
                                  {d.toLocaleString("mn-MN", {
                                    // ✅ “1 өдрийн зөрүү” харагдахаас сэргийлнэ (UTC асуудал)
                            ...
                            <div className="mt-3 flex flex-wrap gap-2">
                              {g.codes.map((c) => (
                                <span
                                  key={c}
                                  title={c}
                                  className="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-sm font-extrabold text-emerald-200"
                                >
                                  {prettyCode(c)}
                                </span>
                              ))}
                      ...
                      {data.groups.length === 0 && (
                        <div className="rounded-2xl border border-white/10 bg-black/35 p-4 text-white/75">
