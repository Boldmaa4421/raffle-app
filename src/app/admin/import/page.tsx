...
export default function ImportPage() {
  ...
  // ✅ Танай Excel header-гүй, A/B/C багана fixed тул array-based уншина.
  async function readExcelRows(file: File): Promise<Row[]> {
    ...
    // header:1 → мөрийг array байдлаар авна (A,B,C,…)
    ...
    for (let i = 0; i < raw.length; i++) {
      ...
      const purchasedAt = r[0]; // A багана → Огноо
      const amount = r[1]; // B багана → Дүн
      const phone = r[2]; // C багана → Утас + текст
